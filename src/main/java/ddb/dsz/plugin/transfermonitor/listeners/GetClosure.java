...
public class GetClosure implements Closure, RetrieveClosureInterface {
   ...
   public GetClosure(TransferMonitorHost var1, CoreController var2) {
      this.monitor = var1;
      this.core = var2;
