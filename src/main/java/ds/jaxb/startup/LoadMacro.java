...
public class LoadMacro {
   @XmlElement(
      name = "Detached"
   )
   protected LoadMacro.Detached detached;
   @XmlElement(
      name = "InitArgs"
   )
   ...
   public LoadMacro.Detached getDetached() {
      return this.detached;
   }

   public void setDetached(LoadMacro.Detached var1) {
      this.detached = var1;
   }
   ...
   public void setMacroFile(String var1) {
      this.macroFile = var1;
   }
