...
import dsz, dsz.lp, dsz.menu, dsz.version, pc.payload, glob, os, re, shutil, sys
PARAM_ARCH_X86 = 'i386'
PARAM_ARCH_X64 = 'x64'
...
if __name__ == '__main__':
    if main() != True:
        sys.exit(-1)
# okay decompiling D:\work\malware\bvp47\FB\Resources\Pc\PyScripts\Payload\_Prep.pyo
