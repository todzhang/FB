...
import dsz, pc.payload.config, pc.payload.exe, dsz.lp, dsz.path, glob, os, shutil, xml.dom.minidom
    ...
    if params.has_key('extra'):
        ...
        if len(extraInfo) == 2:
            ...
            if type(pivot) == dict:
                ...
                return False
    return True
# okay decompiling D:\work\malware\bvp47\FB\Resources\Pc\PyScripts\Lib\pc\payload\__init__.pyo
